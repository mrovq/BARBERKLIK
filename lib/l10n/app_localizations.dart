...
abstract class AppLocalizations {
  ...
  /// No description provided for @pointsUntilNextReward.
  ///
  /// In en, this message translates to:
  /// **'550 pts until next reward tier'**
  String get pointsUntilNextReward;
  ...
  /// No description provided for @exploreBarbershop.
  ///
  /// In en, this message translates to:
  /// **'Explore Barbershop'**
  String get exploreBarbershop;
  ...
  /// No description provided for @klikmartEssentials.
  ///
  /// In en, this message translates to:
  /// **'KlikMart Essentials'**
  String get klikmartEssentials;
  ...
  /// No description provided for @securityAndSupport.
  ///
  /// In en, this message translates to:
  /// **'Security & Support'**
